...
app.post('/carros', (req, res) => {
  const { marca_veiculo, modelo_veiculo, ano_veiculo,  cliente_id } = req.body;
  db.query('INSERT INTO carros SET ?', { marca_veiculo, modelo_veiculo, ano_veiculo, cliente_id }, (err) => {
    if (err) throw err;
...
app.put('/carros/:id', (req, res) => {
  const { id } = req.params;
  const { marca_veiculo, modelo_veiculo, ano_veiculo,cliente_id } = req.body;
  db.query('UPDATE carros SET ? WHERE carros_id = ?', [{ marca_veiculo, modelo_veiculo, ano_veiculo,cliente_id }, id], (err) => {
    if (err) throw err;
